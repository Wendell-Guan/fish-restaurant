...
const resources = {
  en: {
    translation: {
      ...
      footer: {
        logo: "SuriCatch",
        legalName: "SuriCatch International Seafood Co., Limited",
        copyright: "© 2026 SuriCatch International Seafood Co., Limited · All rights reserved."
      }
    }
  },
  zh: {
    translation: {
      ...
      hero: {
        ...
        descTitle: "南美远洋出口",
        descSubtitle: "野生捕捞,\n极致抗鲜冷链保障。",
        descP1: "苏里鱼是苏里南领先的鱼类分销商，专业出口最优质的野生海洋物种。从大西洋的纯净水域，直接送达您的商业终端。",
      ...
      homeVideo: {
        title: "走进我们的远洋鲜捕",
        subtitle: "从大西洋甲板到全球冷链——看一批苏里鱼的货物是如何流转的。"
      },
      about: {
        eyebrow: "关于苏里鱼",
        title: "源自苏里南\n始于 1995",
        ...
        backToHome: "返回首页",
        storyTitle: "我们的故事",
        storyBody: "苏里鱼是一家成立于 1995 年的苏里南企业。我们最初只是一家小公司，如今已成为苏里南最大的冷冻与鲜捕鱼类加工出口商之一。我们对食品安全、食品质量与稳定供应的坚持，让我们成为一家持续高速成长的企业，在全球多个地区赢得了众多满意客户。",
        videoTitle: "走进苏里鱼",
        pillarsTitle: "我们的坚持",
        pillars: [
        ...
        items: [
          {
            ...
            quote: "“苏里鱼的野生红鲷鱼在规格分级与脂肪含量上始终稳定达标。从帕拉马里博到杰克逊维尔的冷链，是我们运行过最稳定的南美航线之一。”"
          },
          {
            partnerName: "Eastern Fish Company",
          ...
          },
          {
            ...
            quote: "“我们自 1928 年起做海产采购——苏里鱼是我们合作过最稳定的大西洋供应商之一。质量、时效、单据，三项都过关。”"
          }
        ]
      },
      contact: {
      ...
      footer: {
        logo: "SuriCatch",
        legalName: "苏里鱼国际渔业有限公司",
        copyright: "© 2026 苏里鱼国际渔业有限公司 · 版权所有"
      }
    }
  }
};
