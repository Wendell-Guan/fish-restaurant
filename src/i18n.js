  ...
  en: {
    translation: {
      ...
      contact: {
        ...
        hkAddress: "Rooms 2203-2205, 22/F, 148 Electric Road, North Point, Hong Kong",
  ...
  zh: {
    translation: {
      ...
      hero: {
        ...
        descTitle: "南美远洋出口",
        descSubtitle: "野生捕捞,\n极致抗鲜冷链保障。",
        descP1: "苏里鱼国际渔业有限公司是苏里南领先的鱼类分销商，专业出口最优质的野生海洋物种。从大西洋的纯净水域，直接送达您的商业终端。",
      ...
      about: {
        ...
        backToHome: "返回首页",
        storyTitle: "我们的故事",
        storyBody: "苏里鱼国际渔业有限公司是一家成立于 1995 年的苏里南企业。我们最初只是一家小公司，如今已成为苏里南最大的冷冻与鲜捕鱼类加工出口商之一。我们对食品安全、食品质量与稳定供应的坚持，让我们成为一家持续高速成长的企业，在全球多个地区赢得了众多满意客户。",
      ...
      contact: {
        ...
        salesTitle: "全球销售部",
        hkTitle: "香港办公室",
        hkAddress: "香港北角电气道148号22楼2203-2205室",
        srTitle: "苏里南办公室",
